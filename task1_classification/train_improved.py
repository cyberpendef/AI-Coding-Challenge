...
"""
    with open(os.path.join(REPORTS_DIR, 'task1_classification_report_improved.md'), 'w') as f:
        f.write(report)
        
    print("Task 1 (improved) finished. Report and plots are saved in the 'reports/improved' directory.")
